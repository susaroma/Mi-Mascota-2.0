...
// Initialize Firebase
		var config = {
			apiKey: "AIzaSyAnifUCtuVit5_3crcTo5OzKoYL6GuF1ug",
			authDomain: "mimascota-8f063.firebaseapp.com",
			databaseURL: "https://mimascota-8f063.firebaseio.com",
			projectId: "mimascota-8f063",
			storageBucket: "mimascota-8f063.appspot.com",
			messagingSenderId: "711396945620"
		};
		        ...
		        promesa.then(function(firebaseUser) {
				  // Exito
							...
							ref.once("value").then(function(snapshot) {
							  ...
							  if (YaEnvio) {
							  	window.location = 'ver.html?uid='+uid;  //ver.html?uid='+uid
							  }
								else {
